    ...
    <jet-form-section @submitted="updatePassword">
        ...
        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" value="Nuværende Password" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" value="Ny Password" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" value="Bekræft Ny Password" />
